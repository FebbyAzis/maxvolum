...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 24 Agu 2025 pada 08.08
...
CREATE TABLE `users` (
  ...
  `role` enum('admin','pelanggan','owner') COLLATE utf8mb4_unicode_ci NOT NULL,
...
(3, 'owner', 'owner@gmail.com', NULL, NULL, '$2y$10$GITsD4n.HHrosOEWiPG98uHK2s6GiUo89fvkk/8taGqQj6iKEowni', 'owner', NULL, NULL, '2025-08-19 02:52:32', '2025-08-19 02:52:32');
