                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 text-right">
                          <button class="btn btn-sm btn-info" data-toggle="modal" data-target="#exampleModalLong1{{$item->id}}">Detail</button>
                            @if ($item->status == 'Menunggu')
                            <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#exampleModal3{{$item->id}}">Terima Pesanan</button>
                            @elseif($item->status == 'Diproses')
                            <button class="btn btn-sm btn-success" data-toggle="modal" data-target="#exampleModal4{{$item->id}}">Pesanan Selesai</button>
                            @else
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
           <div class="form-group">
                <label class="form-label" for="exampleInputText1">Input Subtotal</label>
