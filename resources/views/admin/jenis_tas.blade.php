    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" data-toggle="modal" data-target="#exampleModal"><i
                class="fas fa-plus fa-sm text-white-50"></i> Tambah Jenis Tas</a>
        </div>
        @if (session('Success'))
...
@foreach ($jta as $item)
<form action="{{url('edit-jenis-tas/'. $item->id)}}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                <label class="form-label" for="exampleInputText1">Ukuran Tas</label>
                <input type="text" class="form-control" id="exampleInputText1" name="ukuran_tas" value="{{$item->ukuran_tas}}" required>
            </div>
